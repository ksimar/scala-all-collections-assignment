...
object ScoreCardGenerator extends App{
  ...
  val studentList = List(Student(1, "Kunal"), Student(2, "Kunal"), Student(3, "Anmol Mehta"), Student(4, "Geetika"), Student(5, "Mahesh"), Student(6, "Simarpreet"), Student(7, "Ramandeep"), Student(8, "Anuj"), Student(9, "Jatin"), Student(10, "Pankhuri"))
